...
const questions = [
    {
        question: "Qual é a técnica usada por Michelangelo na pintura do teto da Capela Sistina?",
        options: ["Afresco", "Óleo sobre tela", "Colagem", "Gravura"],
        answer: "Afresco",
      },
      {
        question: "O que caracteriza a arte barroca?",
        options: ["Dramaticidade, uso intenso de luz e sombra, e movimento", "Simetria, equilíbrio e serenidade", "Simplicidade e formas geométricas", "Rejeição de temas religiosos"],
        answer: "Dramaticidade, uso intenso de luz e sombra, e movimento",
      },
      {
        question: "Quem foi o responsável pelo desenvolvimento da técnica da perspectiva linear?",
        options: ["Leonardo da Vinci", "Filippo Brunelleschi", "Michelangelo", "Rafael"],
        answer: "Filippo Brunelleschi",
      },
      {
        question: "Qual é o movimento artístico associado ao uso de cores puras e à técnica de aplicação de pequenas pinceladas?",
        options: ["Cubismo", "Pontilhismo", "Barroco", "Surrealismo"],
        answer: "Pontilhismo",
      },
      {
        question: "O que significa 'pintura a óleo'?",
        options: ["Uma técnica de pintura que utiliza pigmentos suspensos em óleo", "Pintura feita com aquarela", "Escultura em madeira", "Desenhos feitos a carvão"],
        answer: "Uma técnica de pintura que utiliza pigmentos suspensos em óleo",
      },
      {
        question: "Quem foi o artista que pintou a obra 'A Noite Estrelada'?",
        options: ["Vincent van Gogh", "Claude Monet", "Pablo Picasso", "Paul Cézanne"],
        answer: "Vincent van Gogh",
      },
      {
        question: "Qual movimento artístico enfatizava a subjetividade e a emoção humana, muitas vezes representando cenas dramáticas?",
        options: ["Expressionismo", "Impressionismo", "Realismo", "Romantismo"],
        answer: "Romantismo",
      },
      {
        question: "O que caracteriza o movimento Dadaísta?",
        options: ["Rejeição da lógica e da razão, com foco na espontaneidade e no absurdo", "Realismo na representação da natureza", "Uso de cores vibrantes e formas geométricas", "Exploração da luz e das sombras"],
        answer: "Rejeição da lógica e da razão, com foco na espontaneidade e no absurdo",
      },
      {
        question: "Quem foi a principal figura do Renascimento italiano responsável por obras como 'Mona Lisa' e 'A Última Ceia'?",
        options: ["Leonardo da Vinci", "Sandro Botticelli", "Michelangelo", "Raphael"],
        answer: "Leonardo da Vinci",
      },
      {
        question: "Qual é o movimento artístico que surgiu como uma reação ao Impressionismo e enfatizava formas geométricas e cores simbólicas?",
        options: ["Pós-Impressionismo", "Romantismo", "Barroco", "Futurismo"],
        answer: "Pós-Impressionismo",
      }
];

const QuizArtes3 = ({ navigation }) => {
