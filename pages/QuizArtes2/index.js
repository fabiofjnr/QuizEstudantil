...
const questions = [
    {
        question: "O que é o Renascimento?",
        options: ["Um movimento artístico e cultural que resgatou os valores da antiguidade clássica", "Um período de expansão colonial", "Um movimento religioso", "Uma técnica de escultura"],
        answer: "Um movimento artístico e cultural que resgatou os valores da antiguidade clássica",
      },
      {
        question: "Quem pintou a obra 'O Nascimento de Vênus'?",
        options: ["Michelangelo", "Sandro Botticelli", "Leonardo da Vinci", "Raphael"],
        answer: "Sandro Botticelli",
      },
      {
        question: "Qual foi a principal inovação artística trazida pelo movimento Impressionista?",
        options: ["A técnica do chiaroscuro", "O uso da luz e cor para captar impressões momentâneas da natureza", "A precisão dos detalhes nas pinturas", "O uso de temas religiosos nas obras"],
        answer: "O uso da luz e cor para captar impressões momentâneas da natureza",
      },
      {
        question: "Quem é o autor da obra 'Guernica', famosa por seu simbolismo contra a guerra?",
        options: ["Vincent van Gogh", "Claude Monet", "Pablo Picasso", "Salvador Dalí"],
        answer: "Pablo Picasso",
      },
      {
        question: "Qual é o movimento artístico que utiliza formas geométricas e cores vibrantes para criar abstrações?",
        options: ["Impressionismo", "Cubismo", "Expressionismo", "Futurismo"],
        answer: "Cubismo",
      },
      {
        question: "O que é uma instalação artística?",
        options: ["Uma obra tridimensional projetada para transformar a percepção do espaço", "Uma técnica de pintura em telas", "Uma performance ao vivo", "Uma forma de arte digital"],
        answer: "Uma obra tridimensional projetada para transformar a percepção do espaço",
      },
      {
        question: "Qual artista é conhecido por suas pinturas que retratam figuras alongadas e distorcidas?",
        options: ["El Greco", "Paul Cézanne", "Diego Velázquez", "Pierre-Auguste Renoir"],
        answer: "El Greco",
      },
      {
        question: "O que é uma colagem (collage) nas artes visuais?",
        options: ["A combinação de diferentes materiais em uma única composição", "A técnica de esculpir mármore", "A pintura com tinta a óleo", "A montagem de peças de cerâmica"],
        answer: "A combinação de diferentes materiais em uma única composição",
      },
      {
        question: "Qual foi o objetivo principal da arte surrealista?",
        options: ["Explorar o inconsciente e os sonhos", "Representar a natureza de forma precisa", "Promover a industrialização", "Abolir o uso de cores"],
        answer: "Explorar o inconsciente e os sonhos",
      },
      {
        question: "Quem foi o principal artista do movimento Expressionista que pintou 'O Grito'?",
        options: ["Edvard Munch", "Wassily Kandinsky", "Henri Matisse", "Claude Monet"],
        answer: "Edvard Munch",
      }
];

const QuizArtes2 = ({ navigation }) => {
