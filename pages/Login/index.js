...
const Login = () => {
  ...
  const handleLogin = () => {
    if (!email || !password) {
      showAlert("Erro!", "É necessário preencher ambos os campos para fazer login!");
      return;
    }
    ...
    signInWithEmailAndPassword(auth, email, password)
      ...
      .catch(error => {
        if (error.code === 'auth/wrong-password') {
          ...
          showAlert("Erro!", "Verifique o e-mail e tente novamente!");
        } else {
          showAlert("Erro!", "Ocorreu um erro ao fazer login! Verifique o e-mail e a senha e tente novamente.");
        }
      });
  };
