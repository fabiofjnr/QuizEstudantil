...
const questions = [
    {
        question: "O que significa a palavra 'escuchar' em português?",
        options: ["Ouvir", "Falar", "Escrever", "Cantar"],
        answer: "Ouvir",
      },
      {
        question: "Complete a frase: 'Yo ____ español todos los días.'",
        options: ["estudio", "estudia", "estudiamos", "estudian"],
        answer: "estudio",
      },
      {
        question: "Qual é a tradução correta de 'escola' para o espanhol?",
        options: ["Escuela", "Biblioteca", "Oficina", "Casa"],
        answer: "Escuela",
      },
      {
        question: "Qual é a forma correta do verbo 'tener' para a primeira pessoa do singular no presente?",
        options: ["Tengo", "Tienes", "Tiene", "Tenéis"],
        answer: "Tengo",
      },
      {
        question: "O que significa a frase '¿Dónde está el baño?'?",
        options: ["Onde está o banheiro?", "Onde está o quarto?", "Onde está a cozinha?", "Onde está a sala?"],
        answer: "Onde está o banheiro?",
      },
      {
        question: "Como se diz 'Eu estou cansado' em espanhol?",
        options: ["Estoy cansado", "Estoy feliz", "Tengo sueño", "Tengo hambre"],
        answer: "Estoy cansado",
      },
      {
        question: "Qual é o plural de 'mujer'?",
        options: ["Mujeres", "Mujeras", "Mujers", "Mujes"],
        answer: "Mujeres",
      },
      {
        question: "Como se diz 'Eu moro no Brasil' em espanhol?",
        options: ["Vivo en Brasil", "Vives en Brasil", "Viven en Brasil", "Vivimos en Brasil"],
        answer: "Vivo en Brasil",
      },
      {
        question: "O que significa a palavra 'feliz' em português?",
        options: ["Feliz", "Triste", "Bravo", "Cansado"],
        answer: "Feliz",
      },
      {
        question: "Complete a frase: 'Nosotros ____ la cena en casa.'",
        options: ["comemos", "come", "comen", "coméis"],
        answer: "comemos",
      }
];

const QuizEspanhol3 = ({ navigation }) => {
