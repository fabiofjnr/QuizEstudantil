...
const questions = [
    {
        ...
        options: ["Aumentar a produção agrícola", "Transformar a produção artesanal em produção mecanizada", "Melhorar as condições de vida dos trabalhadores", "Expandir os impérios coloniais"],
        answer: "Transformar a produção artesanal em produção mecanizada",
      },
      {
        question: "O que foi o Tratado de Tordesilhas?",
        options: ["Um acordo para a paz na Europa", "Um pacto entre Inglaterra e França", "Um tratado que dividiu as terras do Novo Mundo entre Portugal e Espanha", "Um documento sobre direitos humanos"],
        answer: "Um tratado que dividiu as terras do Novo Mundo entre Portugal e Espanha",
      },
      {
        question: "Quem foi o principal líder da independência dos Estados Unidos?",
        options: ["George Washington", "Thomas Jefferson", "Benjamin Franklin", "Alexander Hamilton"],
        answer: "George Washington",
      },
      {
        question: "Qual foi a causa imediata da Primeira Guerra Mundial?",
        options: ["O Tratado de Versalhes", "A Revolução Russa", "O assassinato do arquiduque Francisco Ferdinando", "A disputa colonial na África"],
        answer: "O assassinato do arquiduque Francisco Ferdinando",
      },
      {
        question: "O que foi a Era Vargas?",
        options: ["Um período de governo de Getúlio Vargas no Brasil", "Uma fase de colonização do Brasil", "Uma revolução agrária", "Um período de ditadura militar"],
        answer: "Um período de governo de Getúlio Vargas no Brasil",
      },
      {
        question: "Qual foi a principal ideologia do Nazismo?",
        options: ["Liberalismo", "Socialismo", "Nacionalismo extremista e racismo", "Comunismo"],
        answer: "Nacionalismo extremista e racismo",
      },
      {
        question: "Qual o evento que marcou o início da Revolução Francesa?",
        options: ["A convocação dos Estados Gerais", "A queda da Bastilha", "A publicação da Declaração dos Direitos do Homem", "A execução de Luís XVI"],
        answer: "A convocação dos Estados Gerais",
      },
      {
        question: "O que foi a Guerra Fria?",
        options: ["Um conflito militar entre países europeus", "Um período de tensão política e ideológica entre EUA e URSS", "Uma guerra entre países asiáticos", "Um movimento de independência na América Latina"],
        answer: "Um período de tensão política e ideológica entre EUA e URSS",
      },
      {
        question: "Qual foi o resultado da Conferência de Berlim em 1884-1885?",
        options: ["A unificação da Alemanha", "A criação da Liga das Nações", "A partilha da África entre as potências europeias", "A declaração de guerra à Áustria-Hungria"],
        answer: "A partilha da África entre as potências europeias",
      },
      {
        question: "Quem foi o responsável pela 'Marcha sobre Roma' em 1922?",
        options: ["Benito Mussolini", "Adolf Hitler", "O movimento fascista italiano liderado por Mussolini", "Winston Churchill"],
        answer: "O movimento fascista italiano liderado por Mussolini",
      }

];

const QuizHistoria3 = ({ navigation }) => {
