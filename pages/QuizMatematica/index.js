...
const questions = [
    {
        question: "Qual é o valor de raiz quadrada de 64?",
        options: ["6", "7", "8", "9"],
        answer: "8",
      },
      {
        question: "Qual é a solução da equação linear 3x - 5 = 16?",
        options: ["5", "7", "8", "11"],
        answer: "7",
      },
      {
        question: "Qual é a fórmula para calcular a área de um triângulo?",
        options: ["A área é igual à base vezes a altura dividido por dois", "A área é igual à base vezes a altura", "A área é igual à base mais a altura dividido por dois", "A área é igual à base vezes a altura vezes dois"],
        answer: "A área é igual à base vezes a altura dividido por dois",
      },
      {
        question: "Qual é o valor de 7^2?",
        options: ["14", "21", "49", "56"],
        answer: "49",
      },
      {
        question: "Em uma equação quadrática, o que significa quando o discriminante (Δ) é igual a zero?",
        options: ["A equação não tem solução", "A equação tem duas soluções reais e distintas", "A equação tem duas soluções complexas", "A equação tem uma única solução real"],
        answer: "A equação tem uma única solução real",
      },
      {
        question: "Qual é o resultado de quinze dividido por três multiplicado por dois?",
        options: ["5", "10", "20", "30"],
        answer: "10",
      },
      {
        question: "Qual é o valor de dois quintos mais um quinto?",
        options: ["Três décimos", "Metade", "Três quintos", "Dois quintos"],
        answer: "Três quintos",
      },
      {
        question: "Qual é a fórmula correta para a área de um círculo?",
        options: ["A área é igual a pi vezes o diâmetro", "A área é igual a pi vezes o raio", "A área é igual a pi vezes o raio ao quadrado", "A área é igual a pi vezes o diâmetro ao quadrado"],
        answer: "A área é igual a pi vezes o raio ao quadrado",
      },
      {
        question: "Se um número é 5 vezes menor que 50 qual é esse número?",
        options: ["5", "10", "15", "25"],
        answer: "10",
      },
      {
...
const QuizMatematica = ({ navigation }) => {
    ...
    if (user) {
      try {
        ...
        const quizHistoryEntry = {
          titulo: 'Quiz de Matemática | 1° ano',
          score: totalPoints,
