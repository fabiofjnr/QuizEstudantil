...
const questions = [
    {
      ...
      {
        question: "O que é a urbanização?",
        options: ["Aumento da população rural", "Crescimento da população urbana", "Deslocamento de indústrias para áreas rurais", "Diminuição das cidades"],
        answer: "Crescimento da população urbana",
      },
      {
        question: "Qual é a principal característica do clima tropical?",
        options: ["Elevada temperatura e chuvas abundantes", "Inverno rigoroso e verões quentes", "Frio intenso durante todo o ano", "Temperaturas moderadas e chuvas esparsas"],
        answer: "Elevada temperatura e chuvas abundantes",
      },
      {
        question: "O que é a globalização?",
        options: ["O fechamento de fronteiras", "A valorização da cultura local", "A integração econômica e cultural entre países", "O aumento da produção agrícola"],
        answer: "A integração econômica e cultural entre países",
      },
      {
        question: "Qual é a principal fonte de energia renovável no Brasil?",
        options: ["Petróleo", "Hidrelétricas", "Carvão mineral", "Gás natural"],
        answer: "Hidrelétricas",
      },
      {
        question: "Qual é o bioma característico da Amazônia?",
        options: ["Cerrado", "Pampa", "Floresta tropical", "Caatinga"],
        answer: "Floresta tropical",
      },
      {
        question: "O que caracteriza o regime de monções?",
        options: ["Secas prolongadas", "Climas frios", "Chuvas sazonais e períodos de seca", "Temperaturas constantes"],
        answer: "Chuvas sazonais e períodos de seca",
      },
      {
        question: "Qual é a maior cadeia de montanhas do mundo?",
        options: ["Montanhas Rochosas", "Cordilheira dos Andes", "Alpes", "Montanhas da Escandinávia"],
        answer: "Cordilheira dos Andes",
      },
      {
        question: "Qual dos seguintes é um fator que contribui para a desertificação?",
        options: ["Reflorestamento", "Desmatamento e práticas agrícolas inadequadas", "Uso sustentável da água", "Urbanização planejada"],
        answer: "Desmatamento e práticas agrícolas inadequadas",
      },
      {
        question: "Qual país possui a maior biodiversidade do planeta?",
        options: ["Estados Unidos", "Brasil", "Austrália", "China"],
        answer: "Brasil",
      }
];

const QuizGeografia3 = ({ navigation }) => {
    ...
    if (user) {
      try {
        ...
        const quizHistoryEntry = {
          titulo: 'Quiz de Geografia | 3° ano',
          score: totalPoints,
