...
const questions = [
    {
        ...
        options: ["Aristóteles", "Sócrates", "Platão", "Descartes"],
        answer: "Sócrates",
      },
      {
        question: "Qual é a principal obra de Platão que descreve sua teoria das ideias?",
        options: ["A República", "Ética a Nicômaco", "Metafísica", "O Banquete"],
        answer: "A República",
      },
      {
        question: "Qual é o conceito de 'Maiêutica' desenvolvido por Sócrates?",
        options: ["Um método de perguntar e responder para extrair conhecimento", "A doutrina da imortalidade da alma", "A teoria do conhecimento absoluto", "A prática da retórica para convencer os outros"],
        answer: "Um método de perguntar e responder para extrair conhecimento",
      },
      {
        question: "Quem foi o discípulo mais famoso de Sócrates?",
        options: ["Platão", "Aristóteles", "Epicuro", "Tales de Mileto"],
        answer: "Platão",
      },
      {
        question: "O que significa a expressão 'Penso, logo existo'?",
        options: ["É a conclusão de René Descartes sobre a certeza da própria existência", "É uma máxima de Aristóteles sobre a razão", "É uma afirmação de Sócrates sobre o conhecimento", "É uma frase de Platão sobre a alma"],
        answer: "É a conclusão de René Descartes sobre a certeza da própria existência",
      },
      {
        question: "Qual filósofo desenvolveu o conceito de 'imperativo categórico'?",
        options: ["Immanuel Kant", "Friedrich Nietzsche", "John Locke", "David Hume"],
        answer: "Immanuel Kant",
      },
      {
        question: "O que caracteriza o pensamento de Heráclito?",
        options: ["A ideia de que tudo está em constante mudança", "A crença na imutabilidade das ideias", "O conceito de que o ser é imutável", "A rejeição da filosofia pré-socrática"],
        answer: "A ideia de que tudo está em constante mudança",
      },
      {
        question: "Qual filósofo grego é conhecido por sua obra 'Ética a Nicômaco'?",
        options: ["Sócrates", "Platão", "Aristóteles", "Demócrito"],
        answer: "Aristóteles",
      },
      {
        question: "O que é a dialética segundo Hegel?",
        options: ["Um método de investigação baseado na contradição e síntese de ideias", "A teoria de que o conhecimento é inato", "Uma forma de argumentação que visa refutar o adversário", "Uma prática filosófica que rejeita o uso da razão"],
        answer: "Um método de investigação baseado na contradição e síntese de ideias",
      },
      {
        question: "Quem é o autor da obra 'Assim falou Zaratustra'?",
        options: ["Immanuel Kant", "Friedrich Nietzsche", "Jean-Paul Sartre", "Karl Marx"],
        answer: "Friedrich Nietzsche",
      }
];

const QuizFilosofia = ({ navigation }) => {
    ...
    if (user) {
      try {
        ...
        const quizHistoryEntry = {
          titulo: 'Quiz de Filosofia | 1° ano',
          score: totalPoints,
