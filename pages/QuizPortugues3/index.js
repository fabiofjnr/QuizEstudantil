...
const questions = [
    {
        question: "Qual é a função da crase?",
        options: ["Indicar pluralidade", "Acentuar palavras", "Indicar a fusão da preposição 'a' com o artigo 'a'", "Separar sílabas"],
        answer: "Indicar a fusão da preposição 'a' com o artigo 'a'",
      },
      {
        question: "Qual é a forma correta da expressão 'ele viu eu'?",
        options: ["Ele viu eu mesmo", "Ele me viu", "Ele viu a mim", "Ele viu eu mesmo assim"],
        answer: "Ele me viu",
      },
      {
        question: "Qual é a definição de um adjetivo?",
        options: ["Palavra que indica ação", "Palavra que une orações", "Palavra que qualifica ou caracteriza um substantivo", "Palavra que expressa relação de tempo"],
        answer: "Palavra que qualifica ou caracteriza um substantivo",
      },
      {
        question: "Qual das opções abaixo é um exemplo de metáfora?",
        options: ["O sol brilha no céu", "Ele é um leão em defesa dos amigos", "A casa é grande", "Ela canta como um pássaro"],
        answer: "Ele é um leão em defesa dos amigos",
      },
      {
        question: "Qual é o tema central do poema 'O Casamento do Pequeno Burguês' de Bertolt Brecht?",
        options: ["A beleza da natureza", "A crítica à vida burguesa e suas convenções", "A importância da família", "A celebração do amor"],
        answer: "A crítica à vida burguesa e suas convenções",
      },
      {
        question: "O que caracteriza um texto dissertativo?",
        options: ["Apresentação de argumentos e defesa de uma tese", "Narração de fatos em ordem cronológica", "Uso exclusivo de diálogos", "Apresentação de imagens e ilustrações"],
        answer: "Apresentação de argumentos e defesa de uma tese",
      },
      {
        question: "Qual é a diferença entre homônimos e parônimos?",
        options: ["Homônimos têm significados diferentes", "Homônimos têm a mesma pronúncia; parônimos são semelhantes", "Parônimos têm significados diferentes", "Não há diferença entre eles"],
        answer: "Homônimos têm a mesma pronúncia; parônimos são semelhantes",
      },
      {
        question: "Qual a função do conectivo 'portanto' em uma oração?",
        options: ["Indicar contraste", "Indicar tempo", "Indicar conclusão", "Indicar causa"],
        answer: "Indicar conclusão",
      },
      {
        question: "O que é uma antítese?",
        options: ["A comparação entre dois elementos", "A oposição entre ideias", "A repetição de sons", "A descrição detalhada de um objeto"],
        answer: "A oposição entre ideias",
      },
      {
        question: "Qual é o gênero textual do conto?",
        options: ["Texto acadêmico", "Narrativo com uma trama curta e poucos personagens", "Poético", "Informativo"],
        answer: "Narrativo com uma trama curta e poucos personagens",
      }

];

const QuizPortugues3 = ({ navigation }) => {
    ...
    if (user) {
      try {
        ...
        const quizHistoryEntry = {
          titulo: 'Quiz de Português | 3° ano',
          score: totalPoints,
