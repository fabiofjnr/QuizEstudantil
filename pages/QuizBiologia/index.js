...
const questions = [
    {
        question: "Qual é a unidade básica de estrutura e função dos seres vivos?",
        options: ["Célula", "Órgão", "Tecidos", "Molécula"],
        answer: "Célula",
      },
      {
        question: "Qual organela celular é conhecida como a 'central de energia' da célula?",
        options: ["Ribossomo", "Mitocôndria", "Lisossomo", "Retículo endoplasmático"],
        answer: "Mitocôndria",
      },
      {
        question: "Qual dos seguintes é um tipo de célula encontrada apenas em organismos multicelulares?",
        options: ["Célula animal", "Célula bacteriana", "Célula vegetativa", "Célula procariótica"],
        answer: "Célula animal",
      },
      {
        question: "O que é a fotossíntese e onde ela ocorre nas plantas?",
        options: ["Processo de conversão de luz em energia química, ocorre nos cloroplastos", "Processo de respiração celular, ocorre na mitocôndria", "Processo de absorção de água, ocorre nas raízes", "Processo de divisão celular, ocorre no núcleo"],
        answer: "Processo de conversão de luz em energia química, ocorre nos cloroplastos",
      },
      {
        question: "Qual é a função do núcleo celular?",
        options: ["Produzir proteínas", "Armazenar o material genético", "Realizar a fotossíntese", "Armazenar lipídios"],
        answer: "Armazenar o material genético",
      },
      {
        question: "Qual dos seguintes processos é responsável pela divisão celular em células eucarióticas?",
        options: ["Mitose", "Meiose", "Fagocitose", "Exocitose"],
        answer: "Mitose",
      },
      {
        question: "O que caracteriza os organismos procarióticos?",
        options: ["Não possuem núcleo definido", "Possuem organelas membranosas", "São multicelulares", "Contêm cloroplastos"],
        answer: "Não possuem núcleo definido",
      },
      {
        question: "Qual é a principal função dos ribossomos na célula?",
        options: ["Síntese de proteínas", "Armazenamento de energia", "Transporte de substâncias", "Produção de energia"],
        answer: "Síntese de proteínas",
      },
      {
        question: "O que é o ADN e qual sua importância para os seres vivos?",
        options: ["Ácido desoxirribonucleico, contém as informações genéticas", "Ácido ribonucleico, participa da síntese de proteínas", "Ácido graxo, fornece energia para a célula", "Ácido nucléico, faz parte da membrana celular"],
        answer: "Ácido desoxirribonucleico, contém as informações genéticas",
      },
      {
        question: "Qual estrutura celular é responsável pelo controle das substâncias que entram e saem da célula?",
        options: ["Membrana plasmática", "Parede celular", "Citoplasma", "Núcleo"],
        answer: "Membrana plasmática",
      }
];

const QuizBiologia = ({ navigation }) => {
