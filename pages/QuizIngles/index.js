...
const questions = [
    {
        question: "Qual é a tradução correta da palavra 'apple' em português?",
      ...
      {
        question: "Qual é a forma correta do verbo 'to be' no presente para a terceira pessoa do singular (he/she/it)?",
        options: ["is", "are", "am", "be"],
        answer: "is",
      },
      {
        question: "Qual é a tradução correta de 'livro' em inglês?",
        options: ["Notebook", "Book", "Magazine", "Newspaper"],
        answer: "Book",
      },
      {
        question: "Como se diz 'Eu gosto de futebol' em inglês?",
        options: ["I like football", "I like basketball", "I like soccer", "I like baseball"],
        answer: "I like football",
      },
      {
        question: "Qual é a pergunta correta para saber a origem de alguém?",
        options: ["Where are you from?", "What do you do?", "How old are you?", "Where do you live?"],
      ...
      {
        question: "Qual é o adjetivo que melhor descreve uma pessoa que é feliz?",
        options: ["Sad", "Angry", "Happy", "Tired"],
        answer: "Happy",
      },
      {
        question: "O que significa a frase 'I need help'?",
        options: ["Eu preciso de uma pausa", "Eu preciso de ajuda", "Eu preciso comer", "Eu preciso dormir"],
        answer: "Eu preciso de ajuda",
      },
      {
        question: "Qual é a forma correta do verbo 'to have' no passado para a primeira pessoa do singular?",
