...
const questions = [
    {
        ...
        options: ["Uma medida da temperatura", "Um tipo de energia", "Uma interação que pode mudar o estado de movimento de um corpo", "Uma propriedade de materiais sólidos"],
        answer: "Uma interação que pode mudar o estado de movimento de um corpo",
      },
      {
        question: "Qual é a unidade de medida de trabalho?",
        options: ["Joule por segundo", "Joule", "Newton", "Watt"],
        answer: "Joule",
      },
      {
