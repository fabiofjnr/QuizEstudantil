...
const questions = [
  ...
  {
    question: "Qual é o clima predominante na região do Saara?",
    options: ["Tropical", "Equatorial", "Desértico", "Mediterrâneo"],
    answer: "Desértico",
  },
  {
    question: "Em que hemisfério está localizado o Brasil?",
    options: ["Hemisfério Norte", "Hemisfério Sul", "Hemisfério Oriental", "Hemisfério Ocidental"],
    answer: "Hemisfério Sul",
  },
  {
    question: "O que caracteriza o fenômeno El Niño?",
    options: ["Resfriamento anômalo das águas do Oceano Pacífico", "Aquecimento anômalo das águas do Oceano Pacífico", "Mudança nas correntes marítimas do Atlântico Norte", "Alteração na pressão atmosférica no Atlântico Sul"],
    answer: "Aquecimento anômalo das águas do Oceano Pacífico",
  },
  {
    question: "Qual é o maior deserto do mundo?",
    options: ["Deserto da Árabia", "Deserto do Atacama", "Deserto do Saara", "Deserto da Antártica"],
    answer: "Deserto da Antártica",
  },
  {
    question: "Qual país possui a maior quantidade de ilhas no mundo?",
    options: ["Noruega", "Canadá", "Indonésia", "Suécia"],
    answer: "Canadá",
  },
  {
    question: "O que é o Ponto Nemo?",
    options: ["O ponto mais alto da Terra", "O lugar mais remoto do oceano, distante de qualquer terra firme", "O ponto mais profundo do Oceano Pacífico", "Uma importante linha de fronteira entre países"],
    answer: "O lugar mais remoto do oceano, distante de qualquer terra firme",
  },
  {
    question: "Qual é a principal causa das mudanças climáticas globais?",
    options: ["Desmatamento", "Poluição atmosférica", "Expansão das áreas urbanas", "Todas as alternativas acima"],
    answer: "Todas as alternativas acima",
  },
];

const QuizGeografia2 = ({ navigation }) => {
    ...
    if (user) {
      try {
        ...
        const quizHistoryEntry = {
          titulo: 'Quiz de Geografia | 2° ano',
          score: totalPoints,
