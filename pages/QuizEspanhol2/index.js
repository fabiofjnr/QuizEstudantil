...
const questions = [
    {
        question: "Qual é a tradução de 'cidade' para o espanhol?",
        options: ["Ciudad", "Pueblo", "País", "Barrio"],
        answer: "Ciudad",
      },
      {
        question: "Complete a frase: 'Nosotros ____ al cine todos los sábados.'",
        options: ["vamos", "van", "va", "voy"],
        answer: "vamos",
      },
      {
        question: "Qual é o significado da palavra 'comida' em português?",
        options: ["Comida", "Bebida", "Casa", "Roupas"],
        answer: "Comida",
      },
      {
        question: "Como se diz 'Por favor' em espanhol?",
        options: ["Gracias", "Por favor", "De nada", "Lo siento"],
        answer: "Por favor",
      },
      {
        question: "Qual é o verbo 'ser' na forma de 'yo' (eu) no presente?",
        options: ["Soy", "Es", "Son", "Somos"],
        answer: "Soy",
      },
      {
        question: "O que significa a palavra 'trabajo' em português?",
        options: ["Trabalho", "Carro", "Viagem", "Escola"],
        answer: "Trabalho",
      },
      {
        question: "Como se diz 'Nós moramos no Brasil' em espanhol?",
        options: ["Vivimos en Brasil", "Vivo en Brasil", "Vivís en Brasil", "Viven en Brasil"],
        answer: "Vivimos en Brasil",
      },
      {
        question: "Qual é o plural de 'niño' em espanhol?",
        options: ["Niños", "Niñas", "Niñes", "Ninõs"],
        answer: "Niños",
      },
      {
        question: "Complete a frase: 'Ellos ____ una casa grande.'",
        options: ["tienen", "tenemos", "tiene", "tenéis"],
        answer: "tienen",
      },
      {
        question: "Como se diz 'gato' em espanhol?",
        options: ["Perro", "Caballo", "Gato", "Pez"],
        answer: "Gato",
      }
];

const QuizEspanhol2 = ({ navigation }) => {
