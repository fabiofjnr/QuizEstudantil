...
const questions = [
    {
        ...
        options: ["Uma substância composta por dois ou mais elementos diferentes", "Uma substância que pode ser dividida em outras substâncias mais simples", "Uma substância pura que não pode ser decomposta em substâncias mais simples", "Uma mistura de substâncias que não reage quimicamente"],
        answer: "Uma substância pura que não pode ser decomposta em substâncias mais simples",
      },
      {
        question: "Qual é a unidade básica de um elemento químico?",
        options: ["Molécula", "Composto", "Átomo", "Íon"],
        answer: "Átomo",
      },
      {
        question: "O que é uma molécula?",
        options: ["Um tipo de átomo", "Um elemento químico puro", "Um grupo de átomos ligados entre si", "Uma mistura de diferentes elementos químicos"],
        answer: "Um grupo de átomos ligados entre si",
      },
      {
        question: "Qual é o número de prótons no núcleo de um átomo de hidrogênio?",
        options: ["1", "2", "0", "6"],
        answer: "1",
      },
      {
        question: "Qual é a diferença principal entre os isótopos de um elemento químico?",
        options: ["O número de elétrons", "O número de nêutrons", "O número de prótons", "O número de moléculas"],
        answer: "O número de nêutrons",
      },
      {
        question: "O que é uma reação química?",
        options: ["Um processo onde as substâncias iniciais se transformam em novas substâncias com propriedades diferentes", "Uma mistura física de substâncias diferentes", "Uma alteração física que não resulta em novas substâncias", "A evaporação de um líquido"],
        answer: "Um processo onde as substâncias iniciais se transformam em novas substâncias com propriedades diferentes",
      },
      {
      ...
      },
      {
        ...
        options: ["Uma mistura de diferentes compostos", "Uma substância composta por apenas um tipo de átomo ou molécula", "Uma solução de dois líquidos miscíveis", "Uma mistura de sólidos e líquidos"],
        answer: "Uma substância composta por apenas um tipo de átomo ou molécula",
      },
      {
        question: "Qual é a tabela que organiza todos os elementos químicos de forma sistemática?",
        options: ["Tabela de Solubilidade", "Tabela de Propriedades Periódicas", "Tabela Periódica dos Elementos", "Tabela de Reatividade Química"],
        answer: "Tabela Periódica dos Elementos",
      },
      {
        question: "O que representa o número atômico de um elemento na Tabela Periódica?",
        options: ["O número total de prótons e nêutrons no núcleo", "O número de nêutrons no núcleo", "O número de prótons no núcleo", "O número total de átomos em uma molécula"],
        answer: "O número de prótons no núcleo",
      }
];

const QuizQuimica = ({ navigation }) => {
